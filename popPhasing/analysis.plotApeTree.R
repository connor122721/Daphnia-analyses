...
### load data
  load("/project/berglandlab/connor/rehh/cdlo_250K.Rdata")
  load("/project/berglandlab/connor/rehh/gprime_peaks.replicates.05.Rdata")
  load("/project/berglandlab/connor/rehh/regions.Rdata")
